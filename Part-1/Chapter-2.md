...
Process Management — deciding which program gets CPU time and when (scheduling).
Memory Management — allocating and freeing RAM to processes.
Device Management — talking to hardware via drivers.
File System Management — organizing how data is stored and retrieved on disk.
