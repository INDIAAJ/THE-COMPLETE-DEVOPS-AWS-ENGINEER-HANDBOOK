...
```bash
ps aux                    # Show ALL running processes, all users, detailed format
...
|---|---|---|
|SIGTERM |15 |Default kill signal — polite request to terminate, allows cleanup |
|SIGKILL |9 |Force kill — cannot be caught or ignored, no cleanup |
...
2. What does systemctl enable actually do, versus systemctl start?
3. How would you view the last hour of logs for a specific service?
4. Explain the difference between SIGTERM and SIGKILL.
5. Write a cron expression to run a script every day at 3:45 AM.
6. How do you create a custom systemd service for your own application?
7. What is a zombie process, and how would you identify one?
